console.log('scripts.min.js loaded');
...
$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        console.log('rsvp handler is running');
        e.preventDefault();
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxPutaLzeokk4WtwPZJm4Q7d1vR1qL67urkYYISJ2VqECPiROKo6VLs-CiP4NfijrkW/exec', data)
                .done(function (data) {
                    console.log(data);
    ...
    ,$("header").css({"border-bottom":"solid 1px rgba(55, 36, 40, 0.88)",padding:"50px 0"})
...
//     $(".player").YTPlayer();
//   } else {
//     console.log("YTPlayer not available");
//   }
// });
