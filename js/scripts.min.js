...
$("#rsvp-form").on("submit", function(e) {
    ...
    if (!validHashes.includes(MD5(inviteCode))) {
        $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect."));
        return;
    }

    $.ajax({
        url: "https://script.google.com/macros/s/AKfycbwNp_1etlfsP7dxVLT5XFa7z8RLUihTttOiLFxA1GNgyp5fMLR0c7eTrbI5M1ZhHLwS/exec",
        method: "POST",
        data: data,
        dataType: "json",
        ...
        error: function(xhr, status, error) {
            $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Server error. Please try again later."));
            console.error("RSVP POST error:", status, error);
        }
    });
});
