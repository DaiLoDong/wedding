...
$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            && MD5($('#invite_code').val()) !== '9f0b7340a787526de6ac7c379c8b0cd9') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            fetch('https://script.google.com/macros/s/AKfycbw2KGSY0sYYduj-kmYHnw5ol3I7hy9K9kEGw5tYXkVjlTU52YzwzmVXg9tTQ60g7jC3/exec', {
                method: 'POST',
                mode: 'no-cors',
                headers: {
    ...
    $(function() {
        $(window).scroll(function() {
            ...
            ? (
                ...
                $("header").css({ "border-bottom": "none", padding: "20px 0" })
            )
            // top of page static
            : (
                $("section.navigation").removeClass("fixed"),
                $("header").css({ "border-bottom": "solid 1px rgba(55, 36, 40, 0.88)", padding: "30px 0" })
            );
        });
    });
